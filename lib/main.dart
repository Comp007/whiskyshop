...
import 'package:whiskyshop_app/pages/gestion_paiments_page.dart';
...
import 'package:whiskyshop_app/pages/historique_paiements.dart';
...
void main() async {
  ...
  AwesomeNotifications().initialize(
    null, // utilise l'icône par défaut de l'app
    [
      NotificationChannel(
        channelKey: 'basic_channel',
        channelName: 'Notifications générales',
        channelDescription: 'Notification pour les messages standards',
    ...
    debug: true, // Désactive-le en production
  );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/employe_home": (context) => EmployeHome(),
        "/gerant_home": (context) => GerardHome(),
        ...
        "/gestionPaiements": (context) => GestionPaiementsPage(),
        "/historiquePaiements": (context) => HistoriquePaiementsPage(),
        "/stats": (context) => Stats(),
